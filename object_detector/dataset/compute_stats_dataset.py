...
from  object_detector.dataset.constants import ANATOMICAL_REGIONS, IMAGE_IDS_TO_IGNORE

from  object_detector.path_datasets_and_weights import path_chest_imagenome
